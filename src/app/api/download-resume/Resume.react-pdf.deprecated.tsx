			...
			>
				...
				<View style={{ marginBottom: 6 }}>
					...
					<Details>
						...
						my skills, while making a significant contribution to
				...
				<View style={{ marginTop: 4 }}>
					...
					<Text style={{ fontSize: 8, paddingLeft: 10 }}>
						...
						have very basic knowledge, not very much fluent in those
						fields
					</Text>
				</View>
...
function Heading({ children }: { children: string }) {
	return (
		<View style={{ position: "relative" }}>
			...
			<Text style={style.sectionHeading}>{children}</Text>
		</View>
	);
}
	...
	return (
		<View style={{ fontSize: 12, backgroundColor: "#999", marginTop: "1" }}>
			{educationTableData.map((eachRow, rowIndex) => {
				const rowStyle = rowIndex === 0 ? style.th : {};
				return (
					<View style={{ flexDirection: "row" }}>
...
// export const PDFAsStream = ReactPDF.renderToStream(<MyResumePdf />);

// export const saveAsFile = async (filepath: string) => {
// 	await ReactPDF.render(<PDFPage />, filepath);
// };
