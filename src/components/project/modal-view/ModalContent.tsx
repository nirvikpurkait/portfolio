	...
	try {
		...
		return (
			<>
				...
				<div className={cls(`flex gap-2 mb-4`)}>
...
function ViewLink({
	...
	return (
		<Link
			href={href}
			className={cls(
				`border-solid border-accent border-2 relative after:absolute after:top-0 after:right-full after:w-full after:h-full after:bg-accent after:translate-x-1.5 overflow-hidden px-3 py-1.5 hover:after:translate-x-full after:transition-all after:z-[-1] hover:text-white text-accent dark:text-white after:scale-110 hover:after:scale-110`
			)}
		>
			{children}
		</Link>
